...
function Slider() {
  ...
  return (
    <div className="flex flex-col max-md:pl-4">
      ...
      <Carousel showArrows={true} showThumbs={false} showStatus={false} autoPlay infiniteLoop width={ size <= 1024 ? "80%" : "60%"} className="max-lg:pl-24 max-md:pl-12 max-sm:pl-5">
