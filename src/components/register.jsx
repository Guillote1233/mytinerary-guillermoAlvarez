...
function Register() {
    ...
    const countries = ["Argentina", "Brazil", "Spain", "France", "Japan", "United States", "Australia", "Germany", "Italy"]
      ...
      <div className="form flex justify-center items-center min-h-[82.5vh]">
          <div className="form-body">
              <div>
                  ...
                  <input type="text" id="name" placeholder="First Name" onChange={(e)=>handleChangeData(e)}/>
              </div>
              <div>
                  <label htmlFor="surname">Last Name </label>
                  <input type="text" id="surname" placeholder="LastName" onChange={(e)=>handleChangeData(e)}/>
              </div>
              <div>
              ...
              <div>
                  ...
                  <input type="text" id="profilePicture" placeholder="Url for picture" onChange={(e)=>handleChangeData(e)}/>
              </div>
              <div>
                  <label htmlFor="country">Country </label>
                  <select id="country" placeholder="Country" onChange={(e)=>handleChangeData(e)}>
          ...
          <div>
              <button type="button" className="btn bg-indigo-600 m-2" onClick={handleClick}>Sign Up</button>
          </div>
          <div>
              <button type="button" className="btn bg-indigo-600 m-2" onClick={handleClickWithGoogle}>Sign Up with Google</button>
          </div>
      </div>      
    )       
}
